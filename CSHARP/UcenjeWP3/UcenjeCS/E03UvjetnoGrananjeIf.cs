...
namespace UcenjeCS
{
    internal class E03UvjetnoGrananjeIf
    {
        ...
        public static void Izvedi()
        {
            ...
            {
                Console.WriteLine("7. Jedan od uvjeta nije bi zadovoljen");
            }
            //logičko ili  ALTGR+W  |
            //| uvijek se provjeravaju oba uvjeta
            //|| ukoliko prvi uvjet zadovoljen drugi se ne provjerava
            if(i==7 || j==5)
            {
            ...
            {
                Console.WriteLine("9.Niti jedan uvijet nije zadovoljen");
            }
            //logično not !
            ...
            if((i>0 && i<10) || !(i <5))
                    {
                Console.WriteLine("10. Zadovoljen kompliciran uvijet");
            }
            ...
            {
                Console.WriteLine("13. i nije i ili 2");
            }

            //inline if
            //kada if poziva naredbu s različitim parametrima
            if(i ==3)
            {
